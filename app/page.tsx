...
>
  <div className="max-w-5xl mx-auto">
    ...
    <h2 className="text-5xl font-bold text-center text-green-400 mb-4">
      🧠 Microgreen Health Analyzer
    </h2>

    <p className="text-center text-gray-400 mb-12 text-lg">
      Tell us your health goal and discover the microgreens
      that may best support your lifestyle.
    </p>

    <div className="grid md:grid-cols-3 gap-6">

      <div className="bg-black/40 border border-green-500/30 rounded-3xl p-8 hover:border-green-400 transition cursor-pointer">
        <h3 className="text-2xl font-bold mb-3">
          💪 Muscle Gain
        </h3>

        <p className="text-gray-400">
          Find nutrient-rich microgreens for active lifestyles.
        </p>
      </div>
      ...
      <div className="bg-black/40 border border-green-500/30 rounded-3xl p-8 hover:border-green-400 transition cursor-pointer">
        ...
        <p className="text-gray-400">
          Discover low-calorie nutrient-dense options.
        </p>
      </div>
      ...
      <div className="bg-black/40 border border-green-500/30 rounded-3xl p-8 hover:border-green-400 transition cursor-pointer">
        ...
        <p className="text-gray-400">
          Explore antioxidant-rich microgreens.
        </p>
      </div>
    ...
    <div className="text-center mt-10">
      <button className="bg-green-500 hover:bg-green-400 text-black font-bold px-8 py-4 rounded-full">
        Start Analysis →
      </button>
    </div>
